...
export function AddLessonForm({ isOpen, onClose, day, lessonSlot, lesson, onSave, onClear, timeSlot, relatedPlan, onViewPlan, availablePlans }: AddLessonFormProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    const lessonData: Omit<Lesson, 'id'|'lessonSlot'> = {
      ...values,
      planId: values.planId === 'no-plan' ? undefined : values.planId,
      time: timeSlot.split(' - ')[0]
    };
    onSave(day, lessonSlot, lessonData);
    onClose();
  }
