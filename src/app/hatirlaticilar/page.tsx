                            ...
                            <div className="space-y-3">
                                {upcomingReminders.length > 0 ? (
                                    upcomingReminders.map(reminder => {
                                        ...
                                        const isOverdue = !isToday(date) && isPast(date);
                                        return (
                                            <div key={reminder.id} className="flex items-center space-x-4 p-4 rounded-lg bg-card border">
                                                <Checkbox
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="text-sm text-muted-foreground flex items-center gap-2 mt-1">
                                                        <CalendarIconLucide className={cn("h-4 w-4", isOverdue && "text-destructive")} />
